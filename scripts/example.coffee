...
module.exports = (robot) ->
  # console.log "My name is: #{robot.name}"

  robot.hear /badger/i, (res) ->
    res.send "Badgers? BADGERS? WE DON'T NEED NO STINKIN BADGERS"

  # regx = new Regex("hey #{ robot.name }", 'i')

  robot.respond ///Hey///i, (res) ->
    res.send "Hey #{res.message.user.profile.first_name}!"
  ...
  robot.respond /chat/i, (msg) ->
    msg.http("http://www.chatoms.com/chatom.json?Normal=1&Fun=2&Philosophy=3&Out+There=4&Love=5&Personal=7")
      .get() (err, res, body) ->
